...
reservation3 = Reservation.create!(guest_id: dorinda.id, property_id: sonja_townhouse.id, check_in_date: '2023-03-01', check_out_date: '2023-03-08', num_guests: 6)
...
review5 = Review.create!(guest_id: bethenny.id, reviewer_name: bethenny.first_name, property_id: dorinda_bm.id, rating: 5, review: "Say what you want about the hostess, but she sure does make it nice.", review_date: "November 2022")
review6 = Review.create!(guest_id: vanderpump.id, reviewer_name: vanderpump.first_name, property_id: dorinda_bm.id, rating: 5, review: "Now this is what I call an estate!", review_date: "July 2022")
review7 = Review.create!(guest_id: dorit.id, reviewer_name: dorit.first_name, property_id: dorinda_bm.id, rating: 3, review: "Such a chic home but terribly inconvenient to get to from Beverly Hills.", review_date: "February 2022")
review8 = Review.create!(guest_id: melissa.id, reviewer_name: melissa.first_name, property_id: teresa.id, rating: 4, review: "So many memories here... both good and bad. But hey, that's life with family in Jersey!", review_date: "December 2022")
...
review5.photo.attach(io: URI.open('https://rhobnb-seeds.s3.amazonaws.com/rhobnb_media/wives/rhony/bethenny.png'), filename: 'bethenny.png')
review6.photo.attach(io: URI.open('https://rhobnb-seeds.s3.amazonaws.com/rhobnb_media_2/wives/rhobh/vanderpump.png'), filename: 'vanderpump.png')
review7.photo.attach(io: URI.open('https://rhobnb-seeds.s3.amazonaws.com/rhobnb_media_2/wives/rhobh/dorit.png'), filename: 'dorit.png')
review8.photo.attach(io: URI.open('https://rhobnb-seeds.s3.amazonaws.com/rhobnb_media/wives/rhonj/melissa.jpg'), filename: 'melissa.jpg')
